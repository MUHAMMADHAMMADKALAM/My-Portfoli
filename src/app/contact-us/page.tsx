...
export default function ContactUs() {
    return (
        <main id="contact-us" className="justify-center items-center text-center py-10 ">
            ...
            <div className="flex flex-col lg:flex-row bg-white rounded-xl my-10 sm:my-20 mx-6 sm:mx-20 md:mx-28 lg:mx-44 py-10">

                {/* contact-us section  */}
                <section className="flex-1 px-6">
                    <h1 data-aos="zoom-in-up" className="text-violet-950 text-2xl md:text-3xl tracking-wider  font-bold ">Contact-Us</h1>
                    <p data-aos="zoom-in-up" className="text-justify text-gray-700 mt-4 mb-8">
                    ...
                    <div className="space-y-5">
                        <div data-aos="zoom-in-up" className="flex gap-4">
                    ...
                    <div data-aos="zoom-in" className="flex gap-7 py-10 justify-center  ">
                    ...
                    <form action="form">
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="text-left text-violet-950 ">
                                <label data-aos="zoom-in-up" className="font-semibold">FIRST NAME</label>
                                <br />
                                <input data-aos="zoom-in-up" className="my-4 border border-gray-500 rounded-xl h-10 pl-2 w-full" type="text" required placeholder="Enter your First Name" />

                            </div>
                            <div className="text-left text-violet-950 md:ml-3">
                                <label data-aos="zoom-in-up" className="font-semibold ">LAST NAME</label>
                                <br />
                                <input data-aos="zoom-in-up" className="my-4 border border-gray-500 rounded-xl h-10 pl-2 w-full " type="text" required placeholder="Enter your Last Name" />
                        ...
                        <div className="flex  flex-col md:flex-row md:mt-4">
                            <div className="text-left text-violet-950 ">
                                <label data-aos="zoom-in-up" className="font-semibold">E-MAIL</label>
                                <br />
                                <input data-aos="zoom-in-up" className="my-4 border border-gray-500 rounded-xl h-10 pl-2 w-full" type="email" required placeholder="Enter your E-Mail" />

                            </div>
                            <div className="text-left text-violet-950 md:ml-3">
                                <label data-aos="zoom-in-up" className="font-semibold ">PHONE #</label>
                                <br />
                                <input data-aos="zoom-in-up" className="my-4 border border-gray-500 rounded-xl h-10 pl-2 w-full " type="tel" required placeholder="Enter your Phone#" />

                            </div>
                        </div>
                        {/* message section */}
                        <div className="text-left text-violet-950 md:mt-4">
                            <label data-aos="zoom-in" className="font-semibold ">WHAT DO YOU HAVE IN MIND?</label>
                            <br />
                            <textarea data-aos="zoom-in" id="message" name="message" rows={4}
